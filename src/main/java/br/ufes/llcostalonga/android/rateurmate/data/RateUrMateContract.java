...
public class RateUrMateContract {
    ...
    public static final class PresentationEntry implements BaseColumns {
        ...
        public static Uri buildPresentationAssessement(String assessement) {
            return CONTENT_URI.buildUpon().appendPath(assessement).build();
        }
        ...
        public static long getAssessementFromUri(Uri uri) {
